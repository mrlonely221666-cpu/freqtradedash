...
export default function Analytics() {
  ...
  const closed = history.trades.filter((t: any) => t.close_date);
  ...
  return (
    <AppLayout>
      ...
      <Card className="bg-card border-border rounded-md overflow-hidden">
        <div className="flex items-center justify-between px-3 py-2 border-b border-border bg-secondary/40">
          <span className="text-[10px] uppercase tracking-[0.15em] text-muted-foreground font-medium">Performance journalière</span>
